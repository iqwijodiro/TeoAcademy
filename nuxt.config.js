...
export default {
  ...
  head: {
    titleTemplate: '%s - Universidad Teológica Interamericana',
    title: 'utionline',
    htmlAttrs: {
      lang: 'es'
    },
