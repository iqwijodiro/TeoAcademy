    ...
    <v-row>
      ...
      <v-card light width="100%" class="pa-5">
        <v-container>
          ...
          <ul>
            <li>
              __udmyvst [sesión]  / 1 año / Para análisis y pruebas
            </li>
            <li>
              __udmy_2_v57r  / 1 año / Para análisis y pruebas
            </li>
            <li>
              __udmyvstr / 1 año / Para análisis y pruebas
            </li>
            <li>
              access_token / 1 mes / Para autenticación de usuario
            </li>
            <li>
              client_id / 1 mes / Para autenticación de usuario
            </li>
            <li>
              csrftoken / 1 año / Para autenticación de usuario
            </li>
            <li>
              dj_session_id / 1 mes / Para autenticación de usuario
            </li>
            <li>
              visto / 30 minutos / Para mejorar la experiencia y la personalización
            </li>
            <li>
              ud_firstvisit / 1 año / Para mejorar la experiencia y personalizar
            </li>
          </ul>
          <h4>
          ...
          <p>
            Formas de eliminar cookies del navegador:
          </p>
          <ul>
            <li>
              Chrome. Pulse el siguiente enlace:<a href="http://support.google.com/chrome/answer/95647?hl=es" target="_blank">http://support.google.com/chrome/answer/95647?hl=es</a>
            </li>
            <li>
              Internet Explorer Versión 11. Pulse el siguiente enlace:<a href="https://support.microsoft.com/es-es/kb/278835" target="_blank">https://support.microsoft.com/es-es/kb/278835</a>
            </li>
            <li>
              Firefox Versión 18. Pulse el siguiente enlace: <a href="https://www.mozilla.org/es-ES/privacy/websites/#cookies" target="_blank">https://www.mozilla.org/es-ES/privacy/websites/#cookies</a>
            </li>
            <li>
              Safari Versión 5.1. Pulse el siguiente enlace: <a href="http://support.apple.com/kb/PH5042" target="_blank">http://support.apple.com/kb/PH5042</a>
            </li>
            <li>
              Opera. Pulse el siguiente enlace: <a href="http://help.opera.com/Linux/10.60/es-ES/cookies.html" target="_blank">http://help.opera.com/Linux/10.60/es-ES/cookies.html</a>
            </li>
            <li>
