  ...
  >
    ...
    <template #actions>
      ...
      <dialog-success
        ...
        header="¡Gracias por Subscribirte!"
        message="En tu bandeja de correo electrónico recibirás contenido teológico de forma periódica. Esperamos sea de gran utilidad para tu crecimiento espiritual."
      />
      <dialog-error
        v-model="dialogError"
      />
