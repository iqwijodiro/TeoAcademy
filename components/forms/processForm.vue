<template>
  <web-form-dialog
    ...
    title="Registrate para asesorarte con el proceso de implementación"
    :loading="loading"
  ...
  >
        ...
        <v-container>
          <v-row justify="center" dense>
            ...
            >
              ...
              />
              <v-text-field
                v-model="lead.contactInfo.country"
                :rules="[validationRules.required]"
                solo
                clearable
                label="País"
    ...
    <template #actions>
      ...
      <dialog-success
        ...
        message="En tu bandeja de correo electrónico recibirás las indicaciones y recomendaciones que te ayudarán en el proceso de implementación a tu congregación."
      />
      <dialog-error
        v-model="dialogError"
      />
