  ...
  >
    ...
    <template #actions>
      ...
      <dialog-success
        ...
        header="¡Has aplicado a un descuento especial en tu curso!"
        message="En tu bandeja de correo electrónico recibirás la información para el descuento en tu curso elegido."
      />
      <dialog-error
        v-model="dialogError"
      />
